 ...
 * @method static array<string, mixed>|null get()
 * @method static array<string, mixed> paginator(AbstractPaginator<int, mixed>|AbstractCursorPaginator<int, mixed>|Paginator<int, mixed> $resource)
 * @method static array<string, mixed> resourceCollection(ResourceCollection $collection)
 * @method static array<string, mixed> jsonResource(JsonResource $resource)
